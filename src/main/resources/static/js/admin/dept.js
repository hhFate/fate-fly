	...
	$
			.ajax({
				...
				success : function(data) {
					...
					$(".show-user input[value=" + profile.sex + "]").prop(
							"checked", true);
                    $(".show-user input[name=type][value=" + user.userType + "]").prop("checked", true);
					$(".show-user .dept").val(department.name);
					$(".show-user .mobile").val(user.mobile);
					$(".show-user .duty").val(user.duty);
					$(".show-user .email").val(user.email);
...
function updateDept() {
    $("#update-btn-dept").button('loading');
    var options = {
        url : "admin/dept/"+$(".show-dept .id").val(),
        type : 'put',
        dataType : 'json',
        data : {},
        success : function(data) {
    ...
    $("#deptEditForm").ajaxSubmit(options);
}
...
function deptDetail(id) {
	$.ajax({
		...
		dataType : 'json',
		success : function(data) {
			$(".show-dept .id").val(data.id);
            $(".show-dept input[name=type][value=" + data.type + "]").prop( "checked", true);
