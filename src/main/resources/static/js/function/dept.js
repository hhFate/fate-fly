...
function userDetail(uid) {
	$
			.ajax({
				...
				success : function(data) {
					var user = data.user;
					$(".show-user .name").val(user.realName);
					$(".show-user .username").val(user.username);
					$(".show-user input[value=" + user.sex + "]").prop(
							"checked", true);
					$(".show-user .dept").val(user.dept);
					$(".show-user .mobile").val(user.mobile);
					$(".show-user .duty").val(user.duty);
					$(".show-user .email").val(user.email);
					$(".show-user .idCard").val(user.idCard);
					$(".show-user .scope").val(user.scope);
					$(".show-user .tel").val(user.tel);
					$(".show-user .weixin").val(user.weixin);
					$(".show-user .qq").val(user.qq);
					$(".show-user .job").val(user.job);
